...
# 🔐 Cargamos los tokens desde las Config Vars de Heroku
...
# 📺 Comando /eventos para mostrar eventos en vivo
...
def eventos_en_vivo(message):
    ...
    try:
        ...
        if 'results' in data and len(data['results']) > 0:
            ...
            for evento in data['results'][:5]:  # Máximo 5 eventos
            ...
            mensaje = "⚠️ No hay eventos activos ahora mismo."
